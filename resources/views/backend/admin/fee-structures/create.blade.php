    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-800">Create New Fee Structure</h2>
            </div>

            <form action="{{ route('fee-structures.store') }}" method="POST" class="px-6 py-4">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('effective_date') border-red-500 @enderror"
                            id="effective_date" name="effective_date" value="{{ old('effective_date', date('Y-m-d')) }}" required min="{{ date('Y-m-d') }}">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
                        <i class="fas fa-save mr-1"></i> Create Fee Structure
                    </button>
                </div>
            </form>
        </div>
